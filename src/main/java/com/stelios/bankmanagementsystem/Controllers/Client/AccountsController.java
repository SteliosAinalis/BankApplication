...
import com.stelios.bankmanagementsystem.Models.Account;
...
public class AccountsController implements Initializable {
    ...
    private void bindData() {
        ...
        withdrawal_limit.textProperty().bind(((SavingsAccount) client.savingsAccountProperty().get()).withdrawalLimitProperty().asString());
